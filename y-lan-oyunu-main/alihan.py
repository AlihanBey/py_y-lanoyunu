...
class SnakeGame():
    def __init__(self):
        ...
        self.anaPencere.title('Snake Game by Alihan :)') # Pencere ismini belirliyoruz.
        ...
        self.sahipInfo.write("Program Alihan tarafından kodlanmıştır.", align="left", font=("Courier", 9, "normal")) # Skor'umuzu yazdırıyoruz. Ayrıca font ve yazı büyüklüğü ayarlarını yapıyoruz.
...
try:
    ...
    print("Program üzerinde bir hata oluştu alihan.")
    time.sleep(0.5)
    exit()
